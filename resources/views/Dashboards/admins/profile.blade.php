          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <a href="#" class="btn btn-primary btn-block"><b>Change Profile Image</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text1" class="form-control" id="newpassword" placeholder="Enter New Password">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="text" class="col-sm-2 col-form-label">Confirm New password</label>
                        <div class="col-sm-10">
                          <input type="text1" class="form-control" id="cnewpassword" placeholder="Re-Enter New Password">
                        </div>
                      </div>
